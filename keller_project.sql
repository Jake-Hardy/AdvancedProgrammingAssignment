...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2016 at 12:58 AM
...
CREATE TABLE IF NOT EXISTS `bid` (
  `buyerEmailAddress` char(20) NOT NULL,
  `bidDate` datetime NOT NULL,
  `homeID` int(11) NOT NULL,
  `bidAmount` decimal(7,2) NOT NULL,
  PRIMARY KEY (`buyerEmailAddress`,`bidDate`,`homeID`)
...
CREATE TABLE IF NOT EXISTS `listing` (
  ...
  `listPeriod` varchar(20) NOT NULL,
  `periodDeadline` date NOT NULL,
  PRIMARY KEY (`listID`)
